<div class="juno-pricing-table <?php echo isset( $instance['scmod_pricing_table_width'] ) ? 'col-sm-' . $instance['scmod_pricing_table_width'] : 'col-sm-4'; ?>">
    ...
    <div class="widget">
        ...
        <div class="inner">
            ...
            <?php if ( !empty( $instance['scmod_pricing_table_url'] ) && !empty( $instance['scmod_pricing_table_button_label'] ) ) : ?>
                <a class="accent-button" href="<?php echo esc_url( $instance['scmod_pricing_table_url'] ); ?>">
