...
if ( $events->have_posts() ) : ?>
    ...
    <div class="juno-events <?php echo isset( $instance['scmod_events_widget_width'] ) ? 'col-sm-' . $instance['scmod_events_widget_width'] : 'col-sm-12'; ?>">
...
<?php else : ?>
    ...
    <h4 class="none-to-display"><?php _e( 'There are currently no upcoming events, please check again at a later time.', 'juno' ); ?></h4>
